...
template <typename KeyT, typename ValueT, SlabHashTypeT SlabHashT, typename DynamicAllocatorT>
class GpuSlabHash;

template <typename KeyT, typename ValueT, SlabHashTypeT SlabHashT, typename AllocatorContextT>
