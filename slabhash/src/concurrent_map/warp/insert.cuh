...
GpuSlabHashContext<KeyT, ValueT, SlabHashTypeT::ConcurrentMap, AllocatorContextT>::insertPair(
    bool& to_be_inserted,
...
GpuSlabHashContext<KeyT, ValueT, SlabHashTypeT::ConcurrentMap, AllocatorContextT>::insertPairUnique(
    bool& to_be_inserted,
    const uint32_t& laneId,
    const KeyT& myKey,
    const ValueT& myValue,
